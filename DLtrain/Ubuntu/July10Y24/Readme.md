...
./DLtrain -m train -s NewNetwork2.dat -c model.txt -n 2000 -e 30 -d Images/

./DLinfer -m infer -s NewNetwork.dat -c model.txt  -f img.raw
./DLinfer -m infer -s NewNetwork2.dat -c model.txt  -f img.raw
